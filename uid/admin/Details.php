...
$Pin=$_POST['Pin'];
$Image=$_POST['Image'];
if(mysql_query("INSERT INTO `tbl_p_details`(`Number`, `Name`, `Pin`, `Image`) VALUES ('$Number','$Name','$Pin','$Image')"))
{
echo "Data saved";
}else{
echo" Data Not saved";
			...
			<td style="width:100%">
				...
				<table style="width:100%">
					...
					<tr>
						...
						<td><input type="text" value="<?php $str=str_shuffle("abcdefghijklmnopqrstuvwxyz0123456789");
echo substr($str,3,5); ?>"  readonly="" /></td>
					</tr>
					<tr>
	...
	<table style="width:100%" border="1px">
		...
		<tr>	
		<?php
			$sql=mysql_query("SELECT * FROM tbl_p_details");
