...
$result = mysql_query("SELECT * FROM tbl_admin WHERE username = '$name' AND Password = '$password'");
...
<form action="" method="post" enctype="multipart/form-data">
			<div id="dec">
				<table align="center" style="background-color:#8B7D1F">
					<tr>
						<td align="center" colspan="2" style="border-bottom:#000000 thin solid; margin-bottom:15px">Admin Panel
						</td>												
					</tr>
					<tr>
